...
//         
   ...
   //     std::cout << "DX2:  " << DX2 << std::endl; 
        ...
        double error_dimu1_X = TREE->dimuon1vtx_xposError->at(i).at(3);
  ...
  //      std::cout << "error_dimu1_X2:  " << error_dimu1_X2 << std::endl; 
        ...
        double error_dimu2_X = TREE->dimuon2vtx_xposError->at(i).at(3);
...
//        std::cout << "DY2:  " << DY2 << std::endl; 
        ...
        double error_dimu1_Y = TREE->dimuon1vtx_yposError->at(i).at(3);
        double error_dimu1_Y2 = error_dimu1_Y * error_dimu1_Y; 
//        std::cout << "error_dimu1_Y2:  " << error_dimu1_Y2 << std::endl;
         
        double error_dimu2_Y = TREE->dimuon2vtx_yposError->at(i).at(3);
...
//         }
   ...
   //     std::cout << "DX2:  " << DX2 << std::endl; 
        ...
        double error_dimu1_X = TREE->dimuon1vtx_xposError->at(i).at(4);
   //     std::cout << "error_dimu1_X:  " << error_dimu1_X << std::endl;
        
        double error_dimu1_X2 = error_dimu1_X * error_dimu1_X;
  //      std::cout << "error_dimu1_X2:  " << error_dimu1_X2 << std::endl; 
         
        double error_dimu2_X = TREE->dimuon2vtx_xposError->at(i).at(4);
        double error_dimu2_X2 = error_dimu2_X * error_dimu2_X;
  //      std::cout << "error_dimu2_X2:  " << error_dimu2_X2 << std::endl;
...
//        std::cout << "DY2:  " << DY2 << std::endl; 
        ...
        double error_dimu1_Y = TREE->dimuon1vtx_yposError->at(i).at(4);
        double error_dimu1_Y2 = error_dimu1_Y * error_dimu1_Y; 
//        std::cout << "error_dimu1_Y2:  " << error_dimu1_Y2 << std::endl;
         
        double error_dimu2_Y = TREE->dimuon2vtx_yposError->at(i).at(4);
        double error_dimu2_Y2 = error_dimu2_Y * error_dimu2_Y;
//        std::cout << "error_dimu2_Y2:  " << error_dimu2_Y2 << std::endl; 
...
//         }
   ...
   //     std::cout << "DX2:  " << DX2 << std::endl; 
        ...
        double error_dimu1_X = TREE->dimuon1vtx_xposError->at(i).at(5);
   //     std::cout << "error_dimu1_X:  " << error_dimu1_X << std::endl;
        
        double error_dimu1_X2 = error_dimu1_X * error_dimu1_X;
  //      std::cout << "error_dimu1_X2:  " << error_dimu1_X2 << std::endl; 
         
        double error_dimu2_X = TREE->dimuon2vtx_xposError->at(i).at(5);
        double error_dimu2_X2 = error_dimu2_X * error_dimu2_X;
  //      std::cout << "error_dimu2_X2:  " << error_dimu2_X2 << std::endl;
...
//        std::cout << "DY2:  " << DY2 << std::endl; 
        ...
        double error_dimu1_Y = TREE->dimuon1vtx_yposError->at(i).at(5);
        double error_dimu1_Y2 = error_dimu1_Y * error_dimu1_Y; 
//        std::cout << "error_dimu1_Y2:  " << error_dimu1_Y2 << std::endl;
         
        double error_dimu2_Y = TREE->dimuon2vtx_yposError->at(i).at(5);
        double error_dimu2_Y2 = error_dimu2_Y * error_dimu2_Y;
//        std::cout << "error_dimu2_Y2:  " << error_dimu2_Y2 << std::endl; 
