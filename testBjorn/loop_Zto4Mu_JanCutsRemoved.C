...
void run(string file){
  ...
  TFile *ntuple = new TFile("28July2022_loop_Zto4Mu_inputFileIs_12July2022_Run2018_Total_JanCutsRemoved_noTrigToRecoMuMatching.root", "RECREATE");
  TTree *aux;
