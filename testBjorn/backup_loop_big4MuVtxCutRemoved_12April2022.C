...
//  std::cout << "myAdd(3,5) "<< myAdd(3,5) << std::endl;
 ...
 // double mu_mu_from_Z_Prob_Cut = 0.05; 
  ...
  TFile *ntuple = new TFile("ntuple_skimmed_big4muVtxCutRemoved_12March2022_inputFileIs_ZYto4Mu_Zto4Mu_pTCut3_MC_Bjorn_17March2022_inputFileIs_MC_DPS_2016_YZ_00623223-2B20-AB42-A456-670F9B3875D5_OR_DoubleMuTrigs.root", "RECREATE");
  TTree *aux;
